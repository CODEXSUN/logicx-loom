...
runNpm(["run", command, "--workspace", "@logicx-loom/platform-api"]);
runNpm(["run", command, "--workspace", "@logicx-loom/platform-web"]);
runNpm(["run", command, "--workspace", "@logicx-loom/mobile"]);
