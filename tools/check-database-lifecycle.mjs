...
const databaseFile = "src/platform/api/src/database/logicx-loom-database.ts";
...
if (!database.includes("logicxLoomDatabaseName()")) {
  throw new Error(`${databaseFile}: single database selection is missing`);
}
console.info(
  "Database lifecycle verified: one database with Identity, notifications, Honey, messaging, and Loom machine data."
);
