...
console.info("[install] installing the self-contained LogicX Loom workspace");
runNpm(["install", "--no-audit", "--no-fund"], root);
console.info("[install] LogicX Loom application, Framework, and UI workspaces are ready.");
