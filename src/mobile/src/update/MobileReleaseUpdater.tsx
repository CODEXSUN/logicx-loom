...
const defaultManifestUrl =
  "https://github.com/CODEXSUN/logicx-loom/releases/latest/download/latest.json";
  ...
  async function installUpdate() {
    ...
    try {
      ...
      if (result.permissionRequired) {
        setMessage("Allow installs from LogicX Loom in Android settings, then tap Update again.");
        setOpen(true);
      }
    } catch {
...
function trustedReleaseUrl(value: string) {
  return value.startsWith("https://github.com/CODEXSUN/logicx-loom/releases/download/");
}
