...
export async function migrateRoleModule(database: Kysely<LogicXLoomDatabase>) {
  await sql
    .raw(
...
async function columnExists(database: Kysely<LogicXLoomDatabase>, column: string) {
