...
export async function migrateUserModule(database: Kysely<LogicXLoomDatabase>) {
  await sql
    .raw(
...
async function columnExists(database: Kysely<LogicXLoomDatabase>, table: string, column: string) {
