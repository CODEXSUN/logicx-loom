...
export function userReferenceContract(database: Kysely<LogicXLoomDatabase>) {
...
export function userFrappeCredentialContract(database: Kysely<LogicXLoomDatabase>) {
  const repository = new UserRepository(database);
  return {
...
export function userFrappeImportContract(context: {
  actorEmail: string;
  database: Kysely<LogicXLoomDatabase>;
}) {
