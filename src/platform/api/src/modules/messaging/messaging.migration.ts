 ...
 */
export async function migrateMessagingModule(database: Kysely<LogicXLoomDatabase>) {
  await sql
    .raw(
...
async function migrateExistingMessagingTimestamps(database: Kysely<LogicXLoomDatabase>) {
