...
const envSchema = z.object({
  ...
  PLATFORM_WEB_PORT: z.coerce.number().int().positive().default(9360),
  ...
  LOGICX_LOOM_DB_FRESH_ON_START: z.enum(["0", "1"]).default("0"),
  LOGICX_LOOM_DB_RESET_CONFIRM: z.string().default(""),
