...
import { LogicXLoomAuthLayout } from "./LogicXLoomAuthLayout";
import { LogicXLoomLandingLayout } from "./LogicXLoomLandingLayout";
...
function LoginSurface({ landing }: { landing: boolean }) {
  ...
  return landing ? (
    <LogicXLoomLandingLayout>{form}</LogicXLoomLandingLayout>
  ) : (
    <LogicXLoomAuthLayout surface="app" title="LogicX Loom Login">
      {form}
    </LogicXLoomAuthLayout>
  );
}
