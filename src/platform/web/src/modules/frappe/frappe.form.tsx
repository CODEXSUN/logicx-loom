        ...
        <WorkspaceFormBody>
          ...
          <div className="mb-5 flex items-start gap-3 rounded-md border bg-muted/25 p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-muted-foreground">
                Settings are saved to the LogicX Loom environment. Secrets are never returned to the
          ...
          <WorkspaceFormGrid>
            ...
            <WorkspaceSwitchCard
              ...
              className="md:col-span-2"
              description="Persist the connection and credentials in LogicX Loom's root .env file. Turn this off to verify without saving."
              disabled={disabled}
