...
The internal runtime used to compose LogicX Loom into one API and one web platform.
...
Business behavior remains in LogicX Loom's owning application modules and is not placed here.
